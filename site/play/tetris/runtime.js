const bundleRoot = new URL("../../runtime/tetris/", import.meta.url);
  ...
  const test = {
    snapshot() {
      return {
        ...
        preset: module._native_gb_debug_preset(),
    ...
    setPreset(preset) {
      return Boolean(module._native_gb_debug_set_preset(preset));
    },
    ...
    readSettings() {
      return module.FS.readFile(`${dataRoot}/enhancements.cfg`, { encoding: "utf8" });
    },
    writeSettings(contents) {
      module.FS.writeFile(`${dataRoot}/enhancements.cfg`, contents);
    },
    flush,
  };
